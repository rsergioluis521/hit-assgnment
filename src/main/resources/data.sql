...
INSERT INTO `item` (`id`, `sku`, `description`, `external_product_number`, `external_reference_sku`, `available`)
VALUES (1, '2000REDL', 'Red shirt, small', '2000', '2000REDAS', 123);
--        (2, 'REDCAP', 'Red cap', '1035', '1035RED', NULL),
--        (3, 'SHIRTREDL', 'Red shirt, large', '2000', '2000REDL', NULL);

INSERT INTO `item_attribute` (`id`, `name`, `description`)
VALUES (1, 'color', NULL),
       (2, 'size', NULL),
       (3, 'material', NULL);

INSERT INTO `item_item_attribute` (`id`, `item_id`, `item_attribute_id`, `value`)
VALUES (1, 1, 1, 'RED');
--        (2, 1, 2, 'S');